...
To build the final jar and optimize the UmemeEmailNotification application for production, run:
...
Then navigate to [http://localhost:9015](http://localhost:9015) in your browser.
...
[Service Discovery and Configuration with the JHipster-Registry]: https://www.jhipster.tech/documentation-archive/v8.0.0-rc.1/microservices-architecture/#jhipster-registry
